    ...
    return(
        <div className='max-w-[1640px] mx-auto p-4'>
           <div className='max-h-[500px] relative'>
            ...
            <img src="https://images.pexels.com/photos/1639565/pexels-photo-1639565.jpeg?auto=compress&cs=tinysrgb&w=1260&h=450&dpr=2" alt="" className='w-full max-h-[500px] object-cover ' />
           </div>
        </div>
    )
}
